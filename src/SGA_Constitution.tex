...
\newcommand{\carticle}[1]{\stepcounter{articlect} \vskip 11pt \noindent \textbf{\underline{Article \Roman{articlect} - #1}}\par}
...
\item The candidate receiving the most votes will be elected to the officer position. In the case of a tie vote, the highest­ ranking officer present will cast the deciding vote.
\end{enumerate}
...
\carticle{Advisor}
\begin{enumerate}
\item A full­time GT faculty or staff member will serve as Advisor to the organization.
